...
para el revisor de Google. Puede ser el nombre de una persona, no hace falta una
empresa.
...
los enlaces. Si el dominio se puede comprar antes del lanzamiento, mejor.
...
## Bloquea que la gente termine de instalar

### 5. Capturas de la instalación

**Dónde van:** `src/pages/descargar.astro`, en los pasos 5 y 6. Hay dos
marcadores de 320 por 420 px.

- Paso 5: la pantalla de Android con el aviso de fuentes desconocidas y el
  interruptor "Permitir de esta fuente".
- Paso 6: el aviso de Play Protect con el botón "Instalar de todos modos".

Son fotos de la pantalla del teléfono, tomadas durante una instalación de
verdad. Ahí es donde se cae la mitad de las instalaciones, así que valen mucho.
...
Tiene que ser la pantalla de resumen del turno cerrado, con el neto del día a la
vista. Es la prueba de que la app hace lo que el titular promete.

**Cómo ponerlas:** guarde la imagen en `public/capturas/`, en formato WebP, y
reemplace el bloque `<Marcador ... />` por:

```astro
<img
  src="/capturas/nombre-del-archivo.webp"
  width="320"
  height="640"
  loading="lazy"
...
## No bloquea nada, pero hay que decidirlo
...
- **Google Play.** El sitio dice de frente que no está ahí y por qué.
